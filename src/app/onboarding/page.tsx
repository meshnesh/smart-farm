...
type FormState = {
  farmName: string;
  location: string;
  sizeInSquareMeters: string; // keep as string for input
  cropsText: string; // comma separated
  zones: string; // string input
};
...
export default function OnboardingPage() {
  ...
  async function onSubmit() {
    ...
    try {
      ...
      // select farm immediately (dashboard reads from this)
      setCurrentFarmId(res.farmId);

      // go to success screen
      router.push(`/onboarding/success?farmId=${encodeURIComponent(res.farmId)}`);
    } catch (e: any) {
    ...
    <OnboardingShell>
      ...
      <div className="p-4 md:p-6">
        <div className="max-w-3xl space-y-4">
          <div>
            <div className="text-sm text-gray-600">Setup • Step 1</div>
            <div className="text-2xl font-semibold">Set up your farm</div>
            <div className="mt-1 text-sm text-gray-600">
              Add the basics first. You can add sensors later.
            </div>
          </div>
              ...
              <div className="grid gap-4">
                ...
                <div>
                  ...
                  <div className="mt-1 text-xs text-gray-500">
                    Used to fetch weather for the dashboard.
                  </div>
                </div>
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <div className="mt-1 text-xs text-gray-500">
                      You can name zones later (Zone A, Zone B…).
                    </div>
                  </div>
                </div>
                ...
                <div className="text-xs text-gray-500">
                  Next: after this we can add sensors + thresholds.
                </div>
              </div>
            </CardBody>
          </Card>
